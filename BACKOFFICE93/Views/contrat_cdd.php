					...
					<div class="panel-body">
						...
						<table data-toggle="table"    data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
							...
							<td>
							    	   ...
							    	   <a onClick="window.open('sal.php?page=cdd&voir=<?php echo $agent->id; ?>','','','')">

                                         <button  class="btn btn-succes" ><span class="glyphicon glyphicon-print" aria-hidden="true"  ></span> <b> Consulter Contrat CDD</b></button>
							    	    </a>
