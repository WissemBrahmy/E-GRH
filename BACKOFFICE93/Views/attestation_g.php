...
immatriculé <?php echo $agent->matricule ?>, numéro carte identité <?php echo $agent->cin ?> et demeurant <?php echo $agent->adresse ?> est employé dans notre entreprise en qualité de <?php echo $agent->grade ?> à temps plein  depuis le <?php echo $agent->date ?> au titre d'un contrat à durée indéterminée.
...
Fait à MONASTIR, le <?php echo date("Y-m-d") ?><br><BR> <br>SIGNATURE<BR><BR>.......... </P>
