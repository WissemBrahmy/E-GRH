						   ...
						   <td> <?php echo ($agent->montant); ?></td>
							...
							<td>
							    	...
							    	<a href="index.php?page=avances&action=supprimer&id=<?php echo $agent->id ; ?>">
							    	 ...
							    	 <a onClick="window.open('sal.php?page=detail_avance&voir=<?php echo $agent->user_id; ?>','','','')" class="btn btn-info" ><span class="fa fa-eye" aria-hidden="true"  ></span> Analyse</a>
