		...
		<div class="page_header clearfix" style="padding-bottom:6px;">
			<div class="page_header_left" style="width: 550px">
				...
				<ul class="bread_crumb">
					...
					<li>
							<h5 style="margin-top: 13px"> Congés En Attentes</h5>
					</li>
				</ul>
			</div>
...
<h3 class="box_header" style=" margin-left: 25px">
		...
		<div class="col-md-5"   style=" word-break: break-all; border:1px solid #D6DBDF  ;  background-color: white">
	...
	<a href="index.php?page=conge_attente&action=delete&id=<?php echo $info->id ; ?>">
							    		<button class="btn btn-danger" onclick="if(!confirm('Voulez-vous vraiment Annulez?')) return false;"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span><b>Annuler<b></button>
							    	</a>
