...
if(isset($_POST["checkout"],$_POST['user_id'],$_POST['code_sortie']) ){
		...
		$emp->pointagesortie((object)$_POST);
	...
	<div class="page_layout page_margin_top clearfix">
		<div class="page_header clearfix">
				...
				<ul class="bread_crumb" style="margin-left: : 15px">
					...
					<li>
							<h5 style="margin-top: 13px">Pointage sortie</h5>
					</li>
				</ul>
			</div>
		<a href="index.php?page=Pointage" >
  <button type="button" class="btn btn-info"><b>Entré</b> </button>
  </a>
		</div>
		<div  >
					...
					<form  method="post"  style="padding-right: 50px;width: 200px" class="contact_form1" >
								...
								Check-out: <input  name="checkout" type="checkbox" value="1" style="margin-left: 20px" /> <br>
							<input name="user_id" type="hidden" value="<?php echo $_SESSION['id']; ?>"  /> &nbsp &nbsp <br>
<fieldset class="left">
							<label>Tapez Le Code Secret de Sortie</label>
							<div class="block">
								<input class="text_input" name="code_sortie" type="password" value="" />
							</div>
